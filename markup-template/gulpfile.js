...
$.gulp.task('dev', ['clean'], function () {
	$.gulp.start('build', 'justCss:build', 'other:build', 'video:build', 'watch', 'webserver');
});
...
$.gulp.task('dist', ['cleanProd'], function () {
	$.gulp.start('buildProd', 'justCss:buildProd', 'jsMin:buildProd', 'other:buildProd', 'video:buildProd', "watch:prod", 'webserverProd', 'messageProd');
});
